...
This section is a tutorial to guide to you the Zephyr Workbench usage on Windows and shows you the steps to follow to create your first "hello_world" application for the FRDM_MCNX947 board from the official Zephyr sources.
