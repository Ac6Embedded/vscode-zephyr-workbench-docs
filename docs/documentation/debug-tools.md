...
It is not provided with Workbench for Zephyr. Please refer to [SEGGER website](https://www.segger.com/downloads/jlink/) to download and to install 
J-Link driver and JLinkServer.

**LinkServer** is a utility for launching and managing GDB servers for NXP debug probes. It is not provided with Workbench for Zephyr. 
...
not supported, Workbench for Zephyr install it on the first time the debug is launch. 
