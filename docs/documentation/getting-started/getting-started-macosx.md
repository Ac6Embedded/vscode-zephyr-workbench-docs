...
Workbench for Zephyr on macOS also required **Homebrew**. Homebrew is an open-source package manager that 
simplifies software installation on macOS (or Linux).
...
system using Homebrew. To remove the packages, use the command:
```bash
...
![Install Host Tools](/img/update/darwin/install-host-tools.png)
...
![Import SDK](/img/update/darwin/toolchain.png)
...
![Import West Workspace](/img/update/darwin/create-wws.png)
...
![Create New Project](/img/update/darwin/create-app.png)


### Edit your code
Edit your project if needed, to access to the project sources, go back to the "Explorer" panel

![Edit source code](/img/update/darwin/edit-code.png)
...
![Build Application](/img/update/darwin/build.png)
...
![Install Runners](/img/update/darwin/install-runners.png)
...
![Edit Debug Configuration](/img/update/darwin/debug-manager.png)
